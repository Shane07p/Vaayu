...
from vaayu_ml.tracking import configure
...
class NowcastModel:
    ...
    def train(self, df: pd.DataFrame, mlflow_run_name: str = "nowcast_xgb") -> None:
        ...
        # Configured centrally: the default filesystem backend is in
        # maintenance mode, and absolute paths break on spaces. See
        # vaayu_ml.tracking.
        configure("vaayu_nowcast")
