...
def run():
    ...
    grid_cells = pd.DataFrame({"grid_cell_code": ["GC-01", "GC-02"], "centroid_lat": [28.6, 28.5], "centroid_lon": [77.2, 77.1]})
    ...
    df = pd.DataFrame({
        ...
        "pm25": [150.0, 110.0],
        "aod_047": [0.5, 0.6], "aod_055": [0.4, 0.5], "aod_uncertainty": [0.1, 0.1], "column_wv": [2.1, 2.2],
        "no2_column": [0.0001, 0.0002], "aer_ai": [1.5, 1.6],
        "blh": [500, 600], "wind_speed": [2.5, 3.0], "wind_direction": [180, 190], "rh": [45, 50], "temp_2m": [300, 301],
        "elevation_m": [215, 245], "road_density_km_per_km2": [8.5, 5.0], "built_up_fraction": [0.85, 0.55],
